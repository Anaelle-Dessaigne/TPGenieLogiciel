...
public class RomanNumberTest {
  ...
  public void toRomanZero() {
	...
	//donne les bonnes valeurs décimales pour des valeurs romaines connues
	@Test
	public void toRoman(15){
		assertTrue("XV");
	}

	//donne les bonnes valeurs romaines pour des valeurs décimales connues
	@Test
	public void fromRoman("XV"){
		assertTrue(15);
	}
	
	//échouer pour des valeurs négatives
	@Test(expected = IllegalArgumentException.class)
	public void toRomanNeg(){
		RomanNumber.valueOf(-1);
	}

	//échouer pour des valeurs en dehors de [1, 3999]
	@Test(expected = IllegalArgumentException.class)
	public void toRomanOutInterval(){
		RomanNumber.valueOf(4000);
	}
	
	//échouer pour des floats
	@Test(expected = IllegalArgumentException.class)
	public void toRomanFloat(){
		RomanNumber.valueOf(0.5);
	}
	...
	//échouer pour des répétitions de paires
	@Test(expected = IllegalArgumentException.class)
	...
	public void CorrectConversion(){
		assertEquals(15, fromRoman(toRoman(15)));
	}
